...
char mem_name[] = "barbershop_semaphore";	// memory name
...
int main(){
    ...
    // shared memory
    shm_unlink(mem_name);
    if ((memory_fd = shm_open(mem_name, O_CREAT | O_EXCL | O_RDWR, 0666)) == -1) {
